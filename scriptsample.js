                  ...
                  success: function (data) {  
                      ...
                      $(data).each(function(i, item){   
                        if ($.inArray(item.iata, planes) != -1)
                        {
                            ...
                            $content += "<div class='col-xs-10 nopadding'><a target='_blank' href="+item.name+">"+item.name+"</a></br>";
                            $content += "<div>"+"Flights: " +fmap[item.iata] +"</br><br/>";
                            $content += "</div></div>";
                         } 
                                  
                      });
                      $(".flights-body").append($content);
